...
### PARENTSTUDENT (RELACION ENTRE APODERADO Y ESTUDIANTE)

- [CREAR NUEVA RELACION ENTRE APODERADO Y ESTUDIANTE](docs/parentStudent/create.md)
- [LISTAR TODAS LAS RELACIONES ENTRE APODERADO Y ESTUDIANTE](docs/parentStudent/get.md)
- [LISTAR RELACION ENTRE APODERADO Y ESTUDIANTE POR ID](docs/parentStudent/getById.md)
- [ACTUALIZAR RELACION ENTRE APODERADO Y ESTUDIANTE](docs/parentStudent/update.md)
- [ELIMINAR RELACION ENTRE APODERADO Y ESTUDIANTE](docs/parentStudent/delete.md)
